...
class ParserDocblock
{
    ...
    public function __construct(string $entity = '', array $baseAlias = ['integer', 'adresse', 'simple', 'simplelanguage', 'vide', 'normal', 'full', 'annonce', 'choice', 'choiceenplace', 'onechoiceenplace', 'entity', 'collection', 'color', 'email', 'password', 'hidden', 'hiddenroot', 'invisible', 'readonlyroot', 'image', 'video', 'fichier', 'money', 'telephone', 'siret', 'iban', 'bic', 'array', 'json', 'order', 'search', 'select', 'string', 'drapeau', 'pass', 'importance', 'stars', 'nombre', 'drag'])
    {
